...
namespace Utils {
    ...
    public class CeilingChecker {
        // TODO: [BG] Unify and merge with GroundChecker. Move jump/fall height calculation to another class.
        /// <summary>
        ...
        /// </summary>
        public bool IsLandedThisFrame => HasCollision && !WasGroundedLastFrame;

        /// <summary>
        /// Returns true when player became ungrounded this frame (jumped, fell off the ground, etc).
        /// </summary>
        public bool IsLeftGroundThisFrame => !HasCollision && WasGroundedLastFrame;
        ...
        public CeilingChecker(BoxCollider2D myCollider, LayerMask groundLayer, int rayCount = 3) {
            if (rayCount < 2) {
        ...
        /// </summary>
        public void Update() {
            WasGroundedLastFrame = HasCollision;
